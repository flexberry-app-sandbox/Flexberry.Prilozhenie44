    ...
    public class Просмотр : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПросмотрE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПросмотрE", typeof(IIS.Prilozhenie_44.Просмотр));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПросмотрL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПросмотрL", typeof(IIS.Prilozhenie_44.Просмотр));
                }
            }
        }
    }
