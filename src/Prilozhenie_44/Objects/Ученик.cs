...
namespace IIS.Prilozhenie_44
{
    ...
    public class Ученик : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Prilozhenie_44.ПриходУход fПриходУход;
        
        private IIS.Prilozhenie_44.Просмотр fПросмотр;
        ...
        [PropertyStorage(new string[] {
                "ПриходУход"})]
        [NotNull()]
        public virtual IIS.Prilozhenie_44.ПриходУход ПриходУход
        {
            get
            {
                ...
                IIS.Prilozhenie_44.ПриходУход result = this.fПриходУход;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Prilozhenie_44.Просмотр.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Просмотр"})]
        public virtual IIS.Prilozhenie_44.Просмотр Просмотр
        {
            get
            {
                ...
                IIS.Prilozhenie_44.Просмотр result = this.fПросмотр;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View УченикE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УченикE", typeof(IIS.Prilozhenie_44.Ученик));
                }
            }
        }
    }
    ...
    public class DetailArrayOfУченик : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Prilozhenie_44.DetailArrayOfУченик members)

        // *** End programmer edit section *** (IIS.Prilozhenie_44.DetailArrayOfУченик members)
        ...
        /// </summary>
        public DetailArrayOfУченик(IIS.Prilozhenie_44.Просмотр fПросмотр) : 
                base(typeof(Ученик), ((ICSSoft.STORMNET.DataObject)(fПросмотр)))
        {
        }
        
        public IIS.Prilozhenie_44.Ученик this[int index]
        {
            get
            {
                return ((IIS.Prilozhenie_44.Ученик)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Prilozhenie_44.Ученик dataobject)
        {
